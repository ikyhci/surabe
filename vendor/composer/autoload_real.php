...
class ComposerAutoloaderInit7e81581022a2fe435766c2b1d60f550e
{
    ...
    public static function getLoader()
    {
        ...
        if ($useStaticLoader) {
            $includeFiles = Composer\Autoload\ComposerStaticInit7e81581022a2fe435766c2b1d60f550e::$files;
        } else {
            $includeFiles = require __DIR__ . '/autoload_files.php';
        }
        foreach ($includeFiles as $fileIdentifier => $file) {
            composerRequire7e81581022a2fe435766c2b1d60f550e($fileIdentifier, $file);
        }
...
function composerRequire7e81581022a2fe435766c2b1d60f550e($fileIdentifier, $file)
{
