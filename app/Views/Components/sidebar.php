    ...
    <div class="sidebar-menu">
      <ul class="menu">
        ...
        <li class="sidebar-item <?php if ($first_part=="/penilaian") {echo "active"; } else  {echo "";} ?>">
          <a href="<?php echo base_url();?>dashboard/penilaian" class='sidebar-link'>
      ...
      <?php if ($usr == 'Soal' || $usr == 'Super Admin') {
        ...
        <li class="sidebar-item <?php if ($first_part=="/tambah-data-penilaian") {echo "active"; } else  {echo "";} ?>">
          <a href="<?php echo base_url();?>dashboard/tambah-data-penilaian" class='sidebar-link'>
            ...
            <span>Tambah Data Penilaian</span>
          </a>
        </li> 
      <?php };?>
      ...
      <?php if ($usr == 'Super Admin') {
       ?>
        ...
        <li class="sidebar-item <?php if ($first_part=="/log-data") {echo "active"; } else  {echo "";} ?>">
          <a href="<?php echo base_url();?>dashboard/log-data" class='sidebar-link'>
      ...
      <?php };?>
        ...
        <li class="sidebar-item <?php if ($first_part=="/help") {echo "active"; } else  {echo "";} ?>">
          <a href="<?php echo base_url();?>dashboard/help" class='sidebar-link'>
